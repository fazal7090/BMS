...
public class Gold implements ActionListener {
    ...
    JPanel panel;
    JComboBox creditlimshow;  String[] cre={"50,000 Rupees", "60,000 Rupees", "70,000 Rupees", "80,000 Rupees"};
   ...
   int accno;
            ...
            
    {
     ...
     accno=Integer.parseInt(cardno);
        ...
        //intro label
        intro=new JLabel("Apply for Gold Credit Card");
       ...
       income.setFont(font5);
        ...
        frame1.add(income);
         ...
         minincome=new JLabel("(Minimun Income =Rs.100,000) ");
    ...
    if (ae.getSource()==back)
    {
     ...
     else if (ae.getSource()==crelimenter)
      {
           ...
           if(selected.equals(cre[0])){
             fineshow.setText("Rs. 2000 over period of one month");
        }
            
          else if(selected.equals(cre[1])){
             fineshow.setText("Rs. 2500 over period of month");
        }
          else if(selected.equals(cre[2])){
             fineshow.setText("Rs. 3000 over period of month");
        }
          else if(selected.equals(cre[3])){
             fineshow.setText("Rs. 3500 over period of one month");
        }
...
String cardname="Gold Credit Card";
